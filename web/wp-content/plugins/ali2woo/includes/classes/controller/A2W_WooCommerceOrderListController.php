    ...
    class A2W_WooCommerceOrderListController {
        ...
        function ajax_save_tracking_code() {
            try {
                ...
                $woocommerce_model = new A2W_Woocommerce();
                $result = $woocommerce_model->save_tracking_code($order_id, $tracking_codes);
        ...
        function assets() {
            ...
            $lang_data = array(
                ...
                'error_cant_do_tracking_sync' => _x('Can`t do Tracking Sync. Unknown error in the Chrome extension. Please contact our support.', 'Error text', 'ali2woo'),
                ...
                'no_tracking_codes_for_order' => _x('No tracking codes for the AliExpress order № ', 'Status', 'ali2woo'),
                'tracking_sync' => _x('Tracking Sync All', 'Button text', 'ali2woo'),
                'error_403_code' => _x('Please log in your AliExpress account to get tracking codes for the AliExpress order № ', 'Error text', 'ali2woo'),
                'tracking_sync_done' => _x('The Tracking Sync is done for the AliExpress order № ', 'Status', 'ali2woo'),
            );
