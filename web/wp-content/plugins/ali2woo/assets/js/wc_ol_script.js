...
jQuery(function ($) {
    ...
    var a2w_get_next_tracking_code = function(data, i, status_code, callback_func){
          ...
          // do not ontinue if status code is 403
          if ((status_code == 200 || status_code == 404) && i < data.length)   {
              ...
              a2w_get_order_tracking_code(data[i].ext_order_id, function(response){
                ...
                callback_func(i, ext_order_id, normalized_codes /*response.tracking_codes*/, response.status_code);
