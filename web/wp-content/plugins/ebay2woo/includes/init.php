...
/**
 * Description of E2W_Init
 *
 * @author andrey
 */
if (!class_exists('E2W_Init')) {
    ...
    class E2W_Init {
        ...
        static public function init_classes($classpath, $default_load_action, $params = array()) {
            $this_class = E2W_Init::getInstance();
                    ...
                    if (is_file($f)) {
                        ...
                        if ($file_info["extension"] == "php") {
                            ...
                            if (isset($file_data['include_action']) && $file_data['include_action']) {
                                $include_action = (!is_null(filter_var($file_data['include_action'], FILTER_VALIDATE_BOOLEAN, FILTER_NULL_ON_FAILURE))) ? (filter_var($file_data['include_action'], FILTER_VALIDATE_BOOLEAN)?self::DEFAULT_INCLIDE_ACTION:"e2w_fake_action") : $file_data['include_action'];
