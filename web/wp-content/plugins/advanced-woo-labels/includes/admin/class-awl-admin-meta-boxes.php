                        ...
                        $html .= '<div class="welcome-panel-content">';
                            ...
                            $html .= '<div class="welcome-panel-column-container">';
                                ...
                                $html .= '<div class="welcome-panel-column">';
                                    ...
                                    $html .= '<ul>';
                                        $html .= '<li><a href="https://advanced-woo-labels.com/guide/create-new-label/" class="welcome-icon welcome-edit-page" target="_blank">' . __( 'Creating New Label', 'advanced-woo-labels' ) . '</a></li>';
                                        $html .= '<li><a href="https://advanced-woo-labels.com/guide/label-conditions/" class="welcome-icon welcome-edit-page" target="_blank">' . __( 'Label Conditions', 'advanced-woo-labels' ) . '</a></li>';
                                        $html .= '<li><a href="https://advanced-woo-labels.com/guide/styling-settings/" class="welcome-icon welcome-edit-page" target="_blank">' . __( 'Label Styling Settings', 'advanced-woo-labels' ) . '</a></li>';
                                    $html .= '</ul>';
                                $html .= '</div>';
                                $html .= '<div class="welcome-panel-column welcome-panel-last">';
                                    $html .= '<h4>' . __( 'Help', 'advanced-woo-labels' ) . '</h4>';
                                    $html .= '<ul>';
                                        $html .= '<li><div class="welcome-icon welcome-widgets-menus"><a href="https://wordpress.org/support/plugin/advanced-woo-labels/" target="_blank">' . __( 'Support Forums', 'advanced-woo-labels' ) . '</a></div></li>';
                                        $html .= '<li><div class="welcome-icon welcome-widgets-menus"><a href="https://advanced-woo-labels.com/contact/" target="_blank">' . __( 'Contact Form', 'advanced-woo-labels' ) . '</a></div></li>';
                                    $html .= '</ul>';
                                $html .= '</div>';
                            $html .= '</div>';
                        $html .= '</div>';
