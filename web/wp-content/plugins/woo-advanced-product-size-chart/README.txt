...
2. Size Chart General Setting page.
3. Product page size chart selection settings
4. Product page size chart position
5. Size chart popup design
6. Admin - Size chart table settings
7. Admin - Add new rows and cols settings
8. Tag based size chart settings
9. Attributes based size chart settings
